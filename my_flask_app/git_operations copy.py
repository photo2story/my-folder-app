...
GITHUB_FLASK_REPO = "photo2story/my-flask-app"  # 플라스크 앱 레포지토리
GITHUB_BRANCH = "main"
...
async def move_files_to_images_folder(file_path):
    ...
    if (filename.startswith("result_alpha_") or 
        filename == "combined_close_prices.csv" or 
...
file_path = os.path.join(csv_path, f'result_AAPL.csv')
